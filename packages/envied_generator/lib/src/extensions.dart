...
extension DartTypeExtension on DartType {
  ...
  /// dart:core library.
  bool get isDartCoreUri => element3?.name3 == 'Uri' && element3?.library2?.isDartCore == true;

  /// Return `true` if this type represents the type 'DateTime' defined in the
  /// dart:core library.
  bool get isDartCoreDateTime => element3?.name3 == 'DateTime' && element3?.library2?.isDartCore == true;
...
extension EnumElement2Extension on EnumElement2 {
  ...
  Iterable<FieldElement2> get values => fields2.where((FieldElement2 fe) => fe.isEnumConstant);
